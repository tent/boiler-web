...
Boiler.Views.RelativeTimestamp = React.createClass({
	...
	render: function () {
		return <span title={Boiler.Helpers.formatDateTime(this.props.milliseconds)}>{Boiler.Helpers.formatRelativeTime(this.props.milliseconds)}</span>;
	}
});
